export default function Country(props) {
    return (<>
    <input className={props.className} list={props.list} id={props.id} name={props.name} placeholder={props.placeholder} required></input>

    <datalist id="list-countryCodes">
      ...
      <optgroup label="Other countries">
        ...
        <option name="CO" value="57" defaultValue>
          Colombia (+57)
        </option>
